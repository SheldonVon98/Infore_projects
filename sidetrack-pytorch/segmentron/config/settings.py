...
# cfg.TRAIN.PRETRAINED_MODEL_PATH = 'checkpoints/best_model.pth'
# cfg.TRAIN.PRETRAINED_MODEL_PATH = './checkpoints/fast_scnn_segmentron.pth'
# cfg.TRAIN.PRETRAINED_MODEL_PATH = './checkpoints/deeplabv3_plus_mobilenetv2_segmentron.pth'
...
cfg.TRAIN.BACKBONE_PRETRAINED_PATH = './checkpoints/mobilenetV2-15498621.pth'
# resume model path
...
cfg.TEST.TEST_MODEL_PATH = './checkpoints/deeplabv3_plus_mobilenetv2_segmentron.pth'
# test batch size
