...
class Trainer(object):
    def __init__(self, args):
        ...
        # print(1)
        # print('object', train_sampler)
        # print('details:', dir(train_sampler))
        # print(train_sampler.data_source)
        #
        # print('details:', dir(train_sampler.data_source))
        # # print(train_sampler.data_source.images)
        # print(train_sampler.data_source.mask_paths)
        # print(train_sampler.data_source.color_jitter)
        # input()
        ...
        # summaryWriter = SummaryWriter("tb")
        # summaryWriter.add_graph(self.model, torch.ones(1, 3, 960, 704).to('cuda:0'))
        # # summaryWriter.add_scalar("train loss", np.array([1,2,3]), np.array([1]))
        # summaryWriter.close()
        # exit(0)
